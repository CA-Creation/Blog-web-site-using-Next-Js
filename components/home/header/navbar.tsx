...
const Navbar = () => {
    ...
    return (
        <div className='sticky top-0 z-50  w-full border-b bg-background/95 backrop-blur supports-[backdrop-filter]:bg-background/60'>
            <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='flex h-16 items-center justify-between'>
                    ...
                    {/*Mobile Menu */}
                    <Button variant={'outline'} size={'icon'} className='md:hidden text-muted-foreground hover:text-foreground'
