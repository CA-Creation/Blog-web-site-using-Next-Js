...
const HeroSection = () => {
  return (
        ...
        <div className="lg:px-20 container relative mx-auto flex h-full flex-col items-center justify-center px-4 py-24 md:flex-row md:py-32">
            {/* Content */}
            ...
            <div className="grid grid-cols-3 gap-4 pt-8 text-white md:max-w-md">
                ...
                <div className='mt-12 flex-1 md:mt-0'>
                    <div className={cn("relative mx-auto w-64 h-64 rounded-2xl overflow-hidden","bg-gradient-to-br from-white/5 to-transparent","border border-primary/20 backdrop-blur-lg","shadow-2xl shadow-indigo-500/10")}>
                        <Image
                            src="https://images.unsplash.com/photo-1545239351-ef35f43d514b?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8YmxvZ3xlbnwwfHwwfHx8MA%3D%3D"
                            alt='hero-image'
                            fill
