        ...
        <Card className={cn("group relative overflow-hidden transition-all hover:scale-[1.02]","border border-gray-200/50 dark:border-white/10","bg-white/50 dark:bg-gray-900/50 backdrop-blur-lg")}>
            <div className='p-6'>
                <Link href='/articles/${1234}'>
                    <div className='relative mb-4 h-48 2-full overflow-hidden rounded-xl'>
                        <Image
                            src="https://images.unsplash.com/photo-1544717302-de2939b7ef71?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
